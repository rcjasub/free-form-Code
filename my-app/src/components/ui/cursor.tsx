...
// Exported (the upstream version keeps this private) so a Cursor/CursorFollow
// pair can be driven by externally-sourced positions — e.g. a collaborator's
// position from a websocket — instead of only ever tracking the local mouse
// via CursorProvider. See RemoteCursorMarker.
